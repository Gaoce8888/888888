...
export class MessageQueue extends EventEmitter {
  ...
  async initStorage() {
    try {
      ...
      logger.error('[MessageQueue] Storage init failed:', error);
    }
  }
  ...
  async restoreFromStorage() {
    ...
    try {
      ...
      if (savedState && savedState.queues) {
        ...
        logger.debug('[MessageQueue] Restored from storage:', this.getStats());
      }
    } catch (error) {
      logger.error('[MessageQueue] Failed to restore from storage:', error);
    }
  }
  ...
  async saveToStorage() {
    ...
    try {
      ...
      logger.error('[MessageQueue] Failed to save to storage:', error);
    }
  }
